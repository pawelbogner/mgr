...
of the motion planning algorithm for a very simple object. 

\subsection{Problem formulation}
The motion planning problem to be solved was analogous to the problem presented
in section \ref{sec:rex_task}. The initial pose